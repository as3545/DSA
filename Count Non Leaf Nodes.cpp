/*
Given a Binary Tree of size N, your task is to complete the function countNonLeafNodes(), which should return the count of all the non-leaf nodes of the given binary tree.
...
2
Explanation:
Nodes 1 and 2 are the only nonleaf nodes.
Your Task:
